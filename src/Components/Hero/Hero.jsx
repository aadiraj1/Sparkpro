...
>
  <source src={assets.videoFile} type="video/mp4" />
        ...
        <div className="ppf-hero">
          ...
          <h3 className="h2-hero">
            Chromic Rims: "Turn heads with gleaming chromic rims –
            precision-engineered, imported for perfection."
          </h3>
        </div>
      </div>
      ...
      <section id="ppf-overview" className="hero-services-content">
        ...
        <div className="hero-ppf-content">
          ...
          <h3>PPF Overview</h3>
          <img className="chrome-img-hero" src={assets.ppfmain_icon} alt="Description f image"/>
          
          <p>
            Our Paint Protection Film (PPF) is sourced directly from the UK and
            US, ensuring the highest quality and performance for your vehicle.
            Made from 100% original, guaranteed PPF, it offers unbeatable
            protection against scratches, chips, and other environmental damages.
            We stand behind the quality of our products, offering a money-back
            guarantee backed by both UK and US standards. When you choose our PPF,
            you’re investing in top-tier vehicle protection that maintains your
            car's pristine appearance while providing long-lasting durability.
            Trust in our imported PPF for unmatched peace of mind and superior
            vehicle care.
          </p>
  ...
  <h2 className="click-fro-ppg-section">Click here for PPF services</h2>
      ...
      <section id="ppf-overview" className="hero-services-content">
        <div className="hero-ppf-content">
          ...
          <img className="chrome-img-hero" src={assets.ceramic_icon} alt="Description f image"/>
          <p>
  ...
  <h2 className="click-fro-ppg-section">Click here for Ceramic Coating services</h2>
      ...
      <section id="ppf-overview" className="hero-services-content">
        <div className="hero-ppf-content">
          ...
          <img className="chrome-img-hero" src={assets.detailing_icon} alt="Description f image"/>
          <p>
  ...
  <h2 className="click-fro-ppg-section">Click here for Car Deep Detailing services</h2>
      ...
      <section id="ppf-overview" className="hero-services-content">
        <div className="hero-ppf-content">
          ...
          <img className="chrome-img-hero" src={assets.glass_icon} alt="Description f image"/>
          <p>
  ...
  <h2 className="click-fro-ppg-section">Click here for Glass Coating services</h2>
      ...
      <section id="ppf-overview" className="hero-services-content">
        <div className="hero-ppf-content">
          ...
          <img className="chrome-img-hero" src={assets.rims_icon} alt="Description f image"/>
          <p>
